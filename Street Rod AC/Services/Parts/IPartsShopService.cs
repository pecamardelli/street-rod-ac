...
namespace Street_Rod_AC.Services.Parts
{
    ...
    public interface IPartsShopService
    {
        ...
        /// <summary>Takes old ads out of the paper and puts new ones in; run once a game day</summary>
        void RefreshAds(GameState gameState, DateTime currentDate);
        ...
        /// <summary>False when the player cannot pay or the ad is gone</summary>
