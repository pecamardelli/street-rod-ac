...
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Global exception handlers              | `Application.DispatcherUnhandledException`, `AppDomain.UnhandledException` and `TaskScheduler.UnobservedTaskException` are wired in `App.xaml.cs`: log, flush Serilog, run AC-content restore, tell the user. **None are wired as of 2026-09-23.** |
